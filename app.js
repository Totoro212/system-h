...
const TRAINING = {
    ...
    tonus: {
        ...
        exercises: [
            {
                name: 'Подтягивания', sets: '3× макс', rest: '90 сек',
                ...
                progression: 'макс → макс+1 каждую неделю → с рюкзаком 3–5 кг'
            },
            {
                name: 'Отжимания на брусьях', sets: '3× макс', rest: '90 сек',
                ...
                progression: '3×макс → замедли темп (3 сек вниз, 3 сек вверх) → с рюкзаком'
            },
            {
