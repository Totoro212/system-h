...
const TRAINING = {
    ...
    legs: {
        ...
        exercises: [
            {
                name: 'Гоблет-приседания (Goblet Squat)', sets: '4×12', rest: '90 сек',
                muscles: 'квадрицепсы, ягодицы, кор',
                weight: '10 кг гантеля перед грудью (гоблет-хват)',
                technique: ['Держи гантелю вертикально двумя руками у груди (как кубок)', 'Стопы чуть шире плеч, носки наружу 15–30°', 'Приседай глубоко — таз ниже колен, локти между коленей', 'Спина прямая, грудь вперёд, пятки в пол', 'Темп: 3 сек вниз, 1 сек пауза внизу, 1 сек вверх'],
                progression: 'Доведи до 4×15, затем переходи на 10+7 кг (рюкзак + гантеля) или делай паузу 3 сек внизу'
            },
            {
                ...
                technique: ['Задняя нога на стуле/диване (подъём стопы на край)', 'Опускайся плавно (3 сек вниз, 1 сек пауза)', 'Колено передней ноги может выходить за носок — это нормально', 'Упор на пятку передней ноги, спина прямая', '❌ НЕ вешай утяжелители на лодыжки — они не дают эффекта в приседах'],
                progression: 'Доведи до 3×12, затем бери обе гантели по 10 кг'
            },
            {
                ...
                weight: '7 кг + 10 кг (по гантеле в каждую руку, всего 17 кг)',
                technique: ['Стоя, гантели перед бёдрами', 'Наклоняйся вперёд, отводя таз назад (как будто закрываешь дверь ягодицами)', 'Спина АБСОЛЮТНО ПРЯМАЯ — никогда не округляй!', 'Гантели скользят вдоль ног (близко к телу)', 'Опускайся до середины голени → почувствуй растяжение хамстрингов', 'Колени слегка согнуты (не блокируй!)'],
                progression: 'Когда 17 кг будет легко → делай на одной ноге с 10 кг (Single-Leg RDL)'
            },
            {
                ...
                alt: 'Улучшает кровообращение в тазовой области (Dorey et al., 2005)',
                progression: 'Доведи до 3×12, затем увеличь паузу вверху до 5 сек'
            },
            {
                name: 'Подъём ног в висе на турнике', sets: '3×10', rest: '60 сек',
                muscles: 'прямая мышца живота, косые, сгибатели бедра',
                weight: '+2–4 кг утяжелители на лодыжки (ВОТ ТУТ они идеальны — увеличивают рычаг)',
                technique: ['Виси на турнике, ноги вместе', 'Поднимай прямые ноги до параллели с полом (или выше)', 'Если слишком сложно — поднимай согнутые колени к груди', 'НЕ раскачивайся! Контролируй подъём и опускание'],
                alt: 'ЭМГ-исследования: максимальная активация пресса среди всех упражнений',
                progression: 'Доведи до 3×12 с 4 кг утяжелителей, затем поднимай ноги к перекладине'
            },
            {
                ...
                progression: 'Увеличивай время → переходи на боковую планку → добавь утяжелители на спину (рюкзак)'
            },
            {
                name: '⭐ Подъёмы на носки (одноногие)', sets: '3×15 /ногу', rest: '30 сек',
                muscles: 'икроножные, камбаловидные', optional: true,
                weight: '10 кг гантеля в руке (другой рукой держись за стену)',
                technique: ['Стоя на одной ноге на краю ступеньки', 'Опускай пятку максимально вниз (полная растяжка)', 'Поднимайся на носок до упора (пауза 2 сек вверху)', 'Медленное опускание — секрет роста икр'],
                progression: 'Доведи до 3×20, затем делай с паузой 3 сек вверху'
            }
        ],
