...
const TRAINING = {
    push: {
        ...
        exercises: [
            ...
            {
                name: 'Пайк-отжимания (Pike Push-Ups)', sets: '4×10', rest: '90 сек',
                ...
                progression: '4×10 → 4×12 → ноги на возвышении → стойка на руках у стены'
            },
            {
    ...
    pull: {
        ...
        exercises: [
            {
                name: 'Подтягивания — широкий хват (пронированный)', sets: '4×9', rest: '120 сек',
                ...
                alt: 'Если не можешь 9 раз: делай сколько можешь чисто, добирай негативными',
                progression: '4×9 → 4×12 → 4×8 с рюкзаком 3–5 кг'
            },
            {
                name: 'Подтягивания — обратный хват (супинированный)', sets: '4×10', rest: '90 сек',
                ...
                progression: '4×10 → 4×12 → 4×8 с рюкзаком'
            },
            {
