...
const TRAINING_INFO = {
    progression: {
        ...
        sections: [
            ...
            { heading: '🚨 Разгрузочная неделя при PPL×2', content: 'Каждые 8–10 недель: те же упражнения, но 50% подходов и повторений. При 6 тренировках/неделю deload обязателен — иначе перетрен ЦНС и суставов.' },
